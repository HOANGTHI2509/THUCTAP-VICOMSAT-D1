        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-semibold text-cockpit-100 leading-tight">
              Trình diễn thuật toán lọc nhiễu cảm biến xăng
            </h1>
            <p className="text-[11px] text-cockpit-400">Hệ thống giám sát nhiên liệu theo thời gian thực</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-2 text-[11px] text-cockpit-400">
            <span className="w-2 h-2 rounded-full bg-fuel-filter animate-pulse" />
            <span>Sẵn sàng trình diễn</span>
          </div>
          <button
            type="button"
