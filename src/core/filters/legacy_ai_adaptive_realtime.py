...
def filter_ai_enhanced_adaptive_realtime(
    ...
    """Bộ lọc Adaptive Kalman tăng cường AI bản cũ (Legacy), dùng làm đường đối sánh."""
    if group.empty:
...
# Alias thuận tiện để gọi và đối sánh trực tiếp với bản cải tiến
filter_legacy_ai_adaptive_realtime = filter_ai_enhanced_adaptive_realtime
